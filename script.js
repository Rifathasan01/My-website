...
function showMenu(event) {
    ...
    popup.style.display = "flex";  // Show the popup using flexbox
}
...
// Close modal when clicking outside of it
window.addEventListener("click", (event) => {
    const PopUpMenu = document.getElementById("popupMenu"); // Correct ID of your modal
    // Check if the click is outside the modal (and not on the trigger or cancel button)
...
// Run on page load and when resized
window.addEventListener("load", updateScrollButtons);
window.addEventListener("resize", updateScrollButtons);

// Optional: update on scroll (for smoother updates if manually scrolling)
